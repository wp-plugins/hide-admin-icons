...
In addition, some padding is added to navigation menu sub-items. To keep the arrow that highlights the current item centered appropriately after the padding is added, a custom image is loaded. This might lead to problems with right to left languages as I haven't had the chance to test and implement this.

If you'd prefer to keep the title icons, either use version 1.2 or edit the mp_hide_admin_icons.css file, the code to be removed has been highlighted.
